...
public class MyAccountBuyerFeagment extends BaseFragment{
	private View view;
	...
	private void InitViewPager() {
		...
		fragments.add(AccountVipFragment.getInstance(null));
	...
	public static Fragment getInstance(String params) {
		MyAccountBuyerFeagment fragment = new MyAccountBuyerFeagment();
